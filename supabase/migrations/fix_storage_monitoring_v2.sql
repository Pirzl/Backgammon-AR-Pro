-- FINAL FIX v2: Corrected column names for pg_stat_user_tables
-- PostgreSQL uses 'relname' not 'tablename'
...
BEGIN
  ...
  -- IMPORTANT: pg_stat_user_tables uses 'relname', not 'tablename'
  RETURN QUERY
  SELECT 
